...
const Progress = ({ color, endColor, progress }) => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <Path strokeDasharray={progress} d="M19 4.0845 a 10.9155 10.9155 0 0 1 0 29.831 a 10.9155 10.9155 0 0 1 0 -29.831" color={color} strokeWidth="9" strokeLinecap="round" />
    <defs>
